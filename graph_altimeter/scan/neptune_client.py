...
to write a graph generated by Altimeter as Security Graph universe snapshot."""
...
class GraphAltimeterNeptuneClient(AltimeterNeptuneClient):
    """Client to run store the a graph generated by Altimeter into a Neptune
    compatible database following the Security Graph Universe schema.

    Args:
        max_age_min: maximum acceptable age in minutes of graphs.  Only graphs
        which are found
    ...
    def __write_vertices(self, g, vertices, scan_id, link_from_id):
        """
        Writes the vertices to the labeled property graph :param g: The graph
        traversal source :param vertices: A list of dictionaries for each
        vertex :param vertex_id: The vertex to ensure a new created vertex is
        linked to :return: None
        """
        cnt = 0
        t = g
        for r in vertices:
